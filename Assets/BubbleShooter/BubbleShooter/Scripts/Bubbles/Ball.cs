...
public class Ball : MonoBehaviour
{
    ...
    IEnumerator FlyToTarget()
    {
        if (itemKind.itemType == ItemTypes.Cub)
        {
            ...
            SoundBase.Instance.GetComponent<AudioSource>().PlayOneShot(SoundBase.Instance.baby[UnityEngine.Random.Range(0, SoundBase.Instance.baby.Length)]);
            //TODO: instance cub prefab
