...
public class LevelEditor : EditorWindow
{
    ...
    string[] toolbarStrings = new string[] { "Levels", "Items", "Settings", "IAP", "Ads", "Help" };
    LevelEditorBase lm;
    private bool enableGoogleAdsProcessing;
    List<AdItem> oldList;
    public ItemKind selectedItem;
    const string itemEditorPath = "Assets/BubbleShooter/Resources/ItemsEditor.asset";
    public ItemsEditorScriptable itemsEditor;
    int[] powerups = new int[4];

    [MenuItem("dotMob/LevelEditor")]
    ...
    void Initialize()
    {
        ...
        GameObject gm = AssetDatabase.LoadAssetAtPath("Assets/BubbleShooter/Resources/LevelEditorBase.prefab",
    ...
    void GUISettings()
    {
        ...
        lm.FirstGems = EditorGUILayout.IntField("Start coins", lm.FirstGems, new GUILayoutOption[] {
            GUILayout.Width (200),
            GUILayout.MaxWidth (200)
        });
        GUILayout.Space(20);
    ...
    void GUIAds()
    {
        ...
        //            GUILayout.MaxWidth (200)
        //        });
     // string labelText = "Install";
#if GOOGLE_MOBILE_ADS
      //  labelText = "Installed";
#endif
        GUILayout.Label("Admob setup", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(150) });
        ...
        //GUILayout.BeginHorizontal();
        //GUILayout.Space(20);
        //lm.admobBannerIDAndroid = EditorGUILayout.TextField("Banner ID Android ", lm.admobBannerIDAndroid, new GUILayoutOption[] {
        //                GUILayout.Width (220),
        //                GUILayout.MaxWidth (220)
        //            });
        //GUILayout.EndHorizontal();
        //GUILayout.BeginHorizontal();
        //GUILayout.Space(20);
        //lm.admobBannerIDIOS = EditorGUILayout.TextField("Banner ID iOS", lm.admobBannerIDIOS, new GUILayoutOption[] {
        //                GUILayout.Width (220),
        //                GUILayout.MaxWidth (220)
        //            });
        //GUILayout.EndHorizontal();
    ...
    void GUIHelp()
    {
        ...
        {
            Application.OpenURL("https://docs.google.com/document/d/1ApZOtMwAGcTtkLNxQkFYrvfJKQu95PaWtCSBVORRkSk/edit?usp=sharing");
        }
        GUILayout.Space(10);
    ...
    void GUILevelSelector()
    {
        ...
        if (GUILayout.Button("Test level", new GUILayoutOption[] { GUILayout.Width(150) }))
        {
            ...
            PlayerPrefs.Save();
            EditorSceneManager.OpenScene("Assets/BubbleShooter/Scenes/game.unity");
    ...
    public void SaveMap(string fileName)
    {
        ...
        {
            //Write to file
            string activeDir = Application.dataPath + @"/BubbleShooter/Resources/Levels/";
